...
export const EXPLORER_URL = process.env.NEXT_PUBLIC_EXPLORER_URL ? removeURLSlash(process.env.NEXT_PUBLIC_EXPLORER_URL) : "https://explorer-git-develop-ternoa.vercel.app"