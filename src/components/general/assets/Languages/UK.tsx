...
const UK: React.FC<UKProps> = ({ className, onClick }) => (
  ...
  >
    ...
    <path
      fill="#fff"
      d="M25.492 14.103L1.096.003.18 2.118l24.398 14.1.915-2.115z"
    />
    <path
      fill="#C61018"
    ...
    <path
      fill="#fff"
      d="M24.58.003L.182 14.103l.915 2.115 24.398-14.1L24.58.003z"
    />
    <path
      fill="#C61018"
    ...
    <path
      fill="#fff"
      d="M24.772 6.14h-10.23V.23h-3.41V6.14H.904v3.941h10.23v5.912h3.41v-5.912h10.229v-3.94z"
    />
    <path
      fill="#C61018"
      d="M24.772 6.928H13.861v-6.7h-2.046v6.7H.903v2.365h10.912v6.7h2.046v-6.7h10.911V6.928z"
    />
  </svg>
);
